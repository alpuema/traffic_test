        ...
        if random.random() < EXPLORATION_RATE:
            ...
            if pheromone_weights is not None and i < len(pheromone_weights):
                ...
                if influence > 2.0:
                    ...
                    range_size = max_dur - min_dur
                    margin = max(2, range_size // 8)
                    duration = random.randint(min_dur + margin, max_dur - margin)
            else:
