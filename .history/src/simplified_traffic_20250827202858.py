...
TRAFFIC_PATTERNS = {
    'balanced': {
        'description': 'Perfectly balanced traffic - equal probability for all origins and destinations',
        'explanation': 'Every grid cell has equal chance of being origin or destination. This creates the most even distribution possible with minimal range between cells.',
    ...
    'commuter': {
        ...
        'explanation': 'Vehicles start from outer edges (suburbs/residential) and travel to inner city center (downtown/business district). Mimics typical morning rush hour.',
        'source_weights': {'perimeter': 1.0},
        'sink_weights': {'center': 1.0},
        'time_distribution': 'early_heavy'
    },
    
    'industrial': {
        'description': 'Industrial corridor pattern - horizontal left-to-right traffic flow',
        'explanation': 'Vehicles travel horizontally across the grid, primarily from left side to right side. Simulates industrial zones with main cargo/freight corridors.',
        'source_weights': {'left_edge': 1.0},
        'sink_weights': {'right_edge': 1.0}, 
