...
TRAFFIC_PATTERNS = {
    ...
    'commuter': {
        'description': 'Rush hour pattern - suburbs to downtown',
        'source_weights': {'perimeter': 3.0, 'center': 0.5},
        'sink_weights': {'center': 4.0, 'perimeter': 1.0},
        'time_distribution': 'early_heavy'
    },
    
    'commercial': {
        'description': 'Shopping district - distributed to concentrated areas',
        'source_weights': {'all': 1.5, 'center': 0.5},
        'sink_weights': {'center': 3.0, 'commercial_zones': 2.0, 'perimeter': 1.0},
        'time_distribution': 'mid_heavy'
    },
    
    'industrial': {
        'description': 'Industrial zone pattern - specific high-traffic corridors',
        'source_weights': {'residential': 2.0, 'perimeter': 1.5},
        'sink_weights': {'industrial': 4.0, 'main_roads': 2.0},
        'time_distribution': 'shift_based'
    },
    
    'balanced': {
        'description': 'Balanced urban traffic with realistic distribution',
        'source_weights': {'perimeter': 2.0, 'residential': 1.5, 'center': 1.0},
        'sink_weights': {'center': 2.5, 'commercial': 1.5, 'perimeter': 1.0},
